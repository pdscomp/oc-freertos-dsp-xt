...
static neopixel_time_t neopixel_get_time(void)
{
    return timer_read_time();
}
static inline void neopixel_delay(neopixel_time_t start, neopixel_time_t ticks)
{
...
#define PULSE_SHORT_TICKS nsecs_to_ticks(50)
#define BIT_MIN_TICKS     nsecs_to_ticks(1000)
