...
#include "../../include/printer/compiler.h" // __section

// Declare a compile time request     //-sendf-G-G-2022-07-21---
#define DECL_CTR(REQUEST)                                               \
    static char __PASTE(_DECLS_, __LINE__)[] __attribute__((used))          __section(".compile_time_request") = (REQUEST)
